% Digital recognition
% In the third experiment, we try to show the anti-noise performances of our proposed algorithms,
% where the test samples are corrupted by random Gaussian noise with different SNR (signal-to-noise ratio)
Database = 'MNIST';
train_num = 7;
